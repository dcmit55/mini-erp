...
class MaterialUsageController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('logistic.material_usage.index', compact('materials', 'projects'));
    }
    ...
    public function show(MaterialUsage $materialUsage)
    {
        ...
        return view('logistic.material_usage.show', compact('materialUsage', 'goodsOutTotal', 'goodsInTotal'));
    }
