...
/**
 * Lark BT-SG Courier ID Staging Table
 *
 * Stores raw courier data from Lark (Batam to Singapore direction)
 * This is a staging table, not final ERP data
 */
class LarkBtSgCourierId extends Model
{
    protected $table = 'lark_bt_sg_courier_ids';
    ...
    {
        return $this->hasMany(LarkBtSgItemTracking::class, 'courier_id');
    }
