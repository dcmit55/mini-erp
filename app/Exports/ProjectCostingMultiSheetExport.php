...
class ProjectCostingMultiSheetExport implements WithMultipleSheets
{
    ...
    {
        return [
            new CostingSummarySheet($this->summaryRows, $this->filters),
            new CostingMaterialSheet($this->materialRows, $this->projectName),
            new CostingWorkmanshipSheet($this->workmanshipRows, $this->projectName),
            new CostingFreightSheet($this->freightRows, $this->projectName),
        ];
    }
}
