...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid py-4">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <div class="d-flex align-items-center">
                                    <div class="ms-2">
                                        <h3 class="mb-1 fw-bold">Welcome, <?php echo e(ucwords($user->username)); ?>!</h3>
        ...
        <div class="row g-4 mb-4">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <div class="metric-value fw-bold fs-3 text-dark"><?php echo e(number_format($inventoryCount)); ?>

                                    </div>
                                    <div class="metric-label text-muted">Total Inventory Items</div>
                                    <div class="metric-trend small">
                                        <span class="text-danger"><i class="fas fa-exclamation-triangle"></i>
                                            <?php echo e($lowStockItems); ?> Low Stock</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card border-0 shadow-sm h-100 card-hover">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <div class="metric-value fw-bold fs-3 text-dark"><?php echo e(number_format($activeProjects)); ?>

                                    </div>
                                    <div class="metric-label text-muted">Active Projects</div>
                                    <div class="metric-trend small">
                                        <span class="text-success"><i class="fas fa-arrow-up"></i>
                                            <?php echo e($projectsThisMonth); ?>
            ...
            <div class="col-xl-3 col-md-6">
                <a href="<?php echo e(route('material_requests.index')); ?>?status=pending" class="text-decoration-none">
                    <div class="card border-0 shadow-sm h-100 card-hover">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <div class="metric-value fw-bold fs-3 text-dark"><?php echo e(number_format($pendingRequests)); ?>

                                    </div>
                                    <div class="metric-label text-muted">Pending Requests</div>
                                    <div class="metric-trend small">
                                        <span class="text-info"><i class="fas fa-info-circle"></i> <?php echo e($totalRequests); ?>
            ...
            <?php if(in_array($user->role, ['super_admin', 'admin_finance', 'admin_logistic'])): ?>
                <div class="col-xl-3 col-md-6">
                    <div class="card border-0 shadow-sm h-100 card-hover">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <div class="metric-value fw-bold fs-3 text-dark">IDR
                                        <?php echo e(number_format($totalInventoryValue, 0, ',', '.')); ?></div>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <div class="metric-value fw-bold fs-3 text-dark">
                                        <?php echo e(number_format($completedProjects)); ?>
                        ...
                        <div class="mt-3">
                            <div class="row text-center">
                                <div class="col-6 border-end">
                                    <div class="fs-4 fw-bold text-warning"><?php echo e($pendingRequests); ?></div>
                                    <div class="small text-muted">Pending</div>
                                </div>
                                <div class="col-6">
                                    <div class="fs-4 fw-bold text-success"><?php echo e($deliveredRequests); ?></div>
        ...
        <div class="row g-4 mb-4">
                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-header bg-transparent border-0 py-3">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a href="<?php echo e(route('material_requests.index')); ?>" class="btn btn-sm btn-outline-brand">View
                                All</a>
                        </div>
                    </div>
                    <div class="card-body p-0" style="max-height: 400px; overflow-y: auto;">
                        <div class="list-group list-group-flush">
                            <?php $__currentLoopData = $recentRequests->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="list-group-item border-0 py-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <div class="fw-semibold"><?php echo e($request->inventory->name ?? 'N/A'); ?></div>
                                            <div class="small text-muted">
                                                Requested by <?php echo e($request->user->username ?? 'N/A'); ?> •
                                                <span
                                                    class="badge <?php echo e($request->getStatusBadgeClass()); ?>"><?php echo e(ucfirst($request->status)); ?></span>
                                            </div>
                                        </div>
            ...
            ?>
            <?php if(isset($veryLowStockItems) && $veryLowStockItems->count() > 0): ?>
                <div class="col-xl-6">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-header bg-transparent border-0 py-3">
                            <div class="d-flex align-items-center justify-content-between flex-wrap low-stock-header">
                                <h5 class="card-title mb-0 fw-bold">
                                    ...
                                    <span class="badge bg-danger"
                                        id="lowStockCount"><?php echo e($veryLowStockItems->count()); ?></span>
                                </h5>
                                <!-- Filter Controls -->
                                <div class="d-flex gap-2 low-stock-filter-controls">
                                    <select id="lowStockCategorySelect" class="form-select form-select-sm select2"
                                        ...
                                        <?php $__currentLoopData = $veryLowStockItems->pluck('category')->filter()->unique('id')->values(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e(\Illuminate\Support\Str::slug($cat->name)); ?>">
                                                <?php echo e($cat->name ?? 'Uncategorized'); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <select id="lowStockSupplierSelect" class="form-select form-select-sm select2"
                                        ...
                                        <?php $__currentLoopData = $veryLowStockItems->pluck('supplier')->filter()->unique('id')->values(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e(\Illuminate\Support\Str::slug($sup->name)); ?>">
                                                <?php echo e($sup->name ?? 'Unknown'); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                        ...
                        <div class="card-body p-0" style="max-height: 400px; overflow-y: auto;">
                            <div id="lowStockListGroup" class="list-group list-group-flush">
                                <?php $__currentLoopData = $veryLowStockItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div
                                        class="list-group-item border-0 py-3 low-stock-item <?php echo e(\Illuminate\Support\Str::slug($item->category->name ?? 'uncategorized')); ?> supplier-<?php echo e(\Illuminate\Support\Str::slug($item->supplier->name ?? 'unknown')); ?>">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <div class="small text-muted">
                                                    <span class="me-2"><i class="fas fa-tag"></i>
                                                        <?php echo e($item->category->name ?? 'Uncategorized'); ?></span>
                                                    <span class="me-2"><i class="fas fa-truck"></i>
                                                        <?php echo e($item->supplier->name ?? '-'); ?></span>
                                                    <span class="me-2"><i class="fas fa-exclamation-circle"></i> Stok:
                                                        <?php echo e($item->quantity); ?> <?php echo e($item->unit ?? '-'); ?></span>
                                                </div>
                                            </div>
                                            <div class="flex-shrink-0 ms-2">
                                                <?php if($canCreatePurchase): ?>
                                                    <a href="<?php echo e(route('purchase_requests.create', ['inventory_id' => $item->id, 'type' => 'restock'])); ?>"
                            ...
                            <?php $__currentLoopData = $departmentStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-6 col-lg-4">
                                    <div class="dept-card bg-light rounded-3 p-3 text-center"
                                        data-department-id="<?php echo e($dept->id); ?>"
                                        data-department-name="<?php echo e($dept->name); ?>">
                                        <div class="dept-icon mb-2">
                                            <i class="fas fa-building text-brand-icon fs-3"></i>
                                        </div>
                                        <h6 class="fw-bold mb-1"><?php echo e(ucfirst($dept->name)); ?></h6>
                                        <div class="small text-muted">
                                            <?php echo e($dept->projects_count); ?> Projects • <?php echo e($dept->users_count); ?> Users
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="card border-0 shadow-sm h-100 mb-0">
                    <div class="card-header bg-transparent border-0 py-3">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a href="<?php echo e(route('projects.index')); ?>" class="btn btn-sm btn-outline-brand">View
                                Projects</a>
                        </div>
                    </div>
                    <div class="card-body p-0" style="height: 100%; max-height: 400px; overflow-y: auto;">
                        <?php if($upcomingDeadlines->count() > 0): ?>
                            <div class="list-group list-group-flush">
                                <?php $__currentLoopData = $upcomingDeadlines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="list-group-item border-0 py-3">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <div class="small text-muted"> Department:
                                                    <?php if($project->departments && $project->departments->count()): ?>
                                                        <?php echo e($project->departments->pluck('name')->implode(', ')); ?>
                                            ...
                                            <div class="flex-shrink-0">
                                                ...
                                                <div class="text-muted small">
                                                    <?php echo e(\Carbon\Carbon::parse($project->deadline)->format('M d, Y')); ?>
                        ...
                        <div class="card-body">
                            <div class="row g-2 mb-2">
                                <div class="col-md-2 col-sm-4 col-6">
                                    <a href="<?php echo e(url('/log-viewer')); ?>" target="_blank"
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        function initializeTrendsChart(months = 6) {
            ...
            const allMonthlyData = <?php echo json_encode($monthlyData, 15, 512) ?>;
        ...
        function initializeRequestStatusChart() {
            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: [<?php echo e($pendingRequests); ?>, <?php echo e($approvedRequests); ?>,
                            <?php echo e($deliveredRequests); ?>
        ...
        function initializeClock() {
            const serverTime = new Date("<?php echo e($serverTime->format('Y-m-d\TH:i:sP')); ?>");
            ...
            document.querySelectorAll('.dept-card[data-department-id]').forEach(card => {
                card.addEventListener('click', function() {
                    ...
                    window.location.href =
                        `<?php echo e(route('projects.index')); ?>?department=${encodeURIComponent(departmentName)}`;
                });
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\27JAN\resources\views/dashboard.blade.php ENDPATH**/ ?>