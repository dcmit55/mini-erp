...
$code = (int) View::yieldContent('code', 404);
        ...
        <div class="error-container">
            <div class="error-icon-wrapper">
                ...
                <div class="error-icon icon-<?php echo $__env->yieldContent('code', '404'); ?>">
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                const errorCode = '<?php echo $__env->yieldContent('code', '404'); ?>';
...
<?php /**PATH D:\27JAN\resources\views/errors/minimal.blade.php ENDPATH**/ ?>