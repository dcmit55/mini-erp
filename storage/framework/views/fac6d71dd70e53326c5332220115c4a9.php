...
<?php $__env->startSection('title', 'DCM Costing Details'); ?>
        ...
        <div class="col-12 col-xl-8">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div>
                    ...
                    <p class="text-muted small mb-0">PO Number: <?php echo e($costing->po_number); ?></p>
                </div>
                <div class="d-flex gap-2">
                    <a href="<?php echo e(route('dcm-costings.edit', ['costing' => $costing->uid])); ?>" 
                       class="btn btn-primary btn-sm rounded-2 px-3">
                        <i class="fas fa-edit me-1"></i>Edit
                    </a>
                    <?php if($costing->purchase): ?>
                    <a href="<?php echo e(route('project-purchases.show', $costing->purchase_id)); ?>" 
                       target="_blank"
            ...
            <div class="card border-0 shadow-sm rounded-3 overflow-hidden">
                <div class="card-body p-3">
                    ...
                    <div class="mb-4">
                        ...
                        <?php if($costing->status == 'approved'): ?>
                            <span class="badge bg-success bg-opacity-10 text-success border border-success border-opacity-25 rounded-2 px-3 py-2 d-inline-flex align-items-center">
                                ...
                                <?php if($costing->approved_at): ?>
                                    <span class="ms-2">• <?php echo e($costing->approved_at->format('d/m/Y H:i')); ?></span>
                                <?php endif; ?>
                            </span>
                    ...
                    <div class="row g-3">
                            ...
                            <div class="bg-light border rounded-2 p-3 h-100">
                                ...
                                <div class="row g-2">
                                    <div class="col-12">
                                        ...
                                        <p class="mb-2 fw-medium"><?php echo e($costing->po_number); ?></p>
                                    </div>
                                    
                                    <div class="col-6">
                                        <label class="form-label small text-muted mb-0">Date</label>
                                        <p class="mb-2 fw-medium"><?php echo e($costing->date->format('d/m/Y')); ?></p>
                                    </div>
                                    
                                    <div class="col-6">
                                        <label class="form-label small text-muted mb-0">Department</label>
                                        <p class="mb-2 fw-medium"><?php echo e($costing->department); ?></p>
                                    </div>
                                    
                                    <div class="col-6">
                                        <label class="form-label small text-muted mb-0">Project Type</label>
                                        <p class="mb-2 fw-medium"><?php echo e(ucfirst($costing->project_type)); ?></p>
                                    </div>
                                    
                                    <div class="col-6">
                                        <label class="form-label small text-muted mb-0">Project Name</label>
                                        <p class="mb-2 fw-medium"><?php echo e($costing->project_name ?? 'N/A'); ?></p>
                                    </div>
                                    
                                    <?php if($costing->job_order): ?>
                                    <div class="col-12">
                                        <label class="form-label small text-muted mb-0">Job Order</label>
                                        <p class="mb-0 fw-medium"><?php echo e($costing->job_order); ?></p>
                                    </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="bg-light border rounded-2 p-3 h-100">
                                ...
                                <div class="row g-2">
                                    <div class="col-12">
                                        ...
                                        <p class="mb-2 fw-medium"><?php echo e($costing->supplier); ?></p>
                                    </div>
                                    
                                    <div class="col-12">
                                        <label class="form-label small text-muted mb-0">PIC</label>
                                        <p class="mb-2 fw-medium"><?php echo e($costing->pic); ?></p>
                                    </div>
                                    
                                    <div class="col-6">
                                        <label class="form-label small text-muted mb-0">Tracking Number</label>
                                        <p class="mb-2 fw-medium"><?php echo e($costing->tracking_number ?? 'N/A'); ?></p>
                                    </div>
                                    
                                    <div class="col-6">
                                        <label class="form-label small text-muted mb-0">Resi Number</label>
                                        <p class="mb-2 fw-medium"><?php echo e($costing->resi_number ?? 'N/A'); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="bg-light border rounded-2 p-3">
                                ...
                                <div class="row g-2">
                                    <div class="col-md-6">
                                        ...
                                        <p class="mb-2 fw-medium"><?php echo e($costing->item_name); ?></p>
                                    </div>
                                    
                                    <div class="col-md-3">
                                        <label class="form-label small text-muted mb-0">Purchase Type</label>
                                        <p class="mb-2 fw-medium"><?php echo e(ucfirst($costing->purchase_type)); ?></p>
                                    </div>
                                    
                                    <div class="col-md-3">
                                        <label class="form-label small text-muted mb-0">Quantity</label>
                                        <p class="mb-2 fw-medium"><?php echo e($costing->quantity); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row g-2">
                                    <div class="col-md-3">
                                        ...
                                        <p class="mb-2 fw-medium text-primary">
                                            Rp <?php echo e(number_format($costing->unit_price, 0, ',', '.')); ?>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <p class="mb-2 fw-medium text-primary">
                                            Rp <?php echo e(number_format($costing->total_price, 0, ',', '.')); ?>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <p class="mb-2 fw-medium text-primary">
                                            Rp <?php echo e(number_format($costing->freight, 0, ',', '.')); ?>
                        ...
                        <!-- Finance Notes -->
                        <?php if($costing->finance_notes): ?>
                        <div class="col-12">
                            <div class="bg-light border rounded-2 p-3">
                                <h6 class="text-dark fw-medium mb-2">
                                    <i class="fas fa-sticky-note me-2 text-primary"></i>Finance Notes
                                </h6>
                                <p class="mb-0"><?php echo e($costing->finance_notes); ?></p>
                            </div>
                        </div>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\27JAN\resources\views/finance/dcm-costings/show.blade.php ENDPATH**/ ?>