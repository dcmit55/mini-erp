        ...
        <div class="col-12 col-xl-8">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div>
                    ...
                    <p class="text-muted small mb-0">PO Number: <?php echo e($purchase->po_number); ?></p>
                </div>
                <div>
            ...
            <div class="card border-0 shadow-sm rounded-3 overflow-hidden">
                <div class="card-body p-3">
                    ...
                    <form action="<?php echo e(route('project-purchases.update', $purchase->id)); ?>" method="POST" id="purchaseForm">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="row g-2">
                                <div class="col-md-6 mb-2">
                                    ...
                                    <select class="form-select border-1 rounded-2 py-2 px-3" 
                                            ...
                                            id="purchaseType" 
                                            required>
                                        <option value="restock" <?php echo e($purchase->purchase_type == 'restock' ? 'selected' : ''); ?>>Restock Material</option>
                                        <option value="new_item" <?php echo e($purchase->purchase_type == 'new_item' ? 'selected' : ''); ?>>New Item</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" 
                                               class="form-control border-1 rounded-2 py-2 px-3" 
                                               name="date" 
                                               value="<?php echo e($purchase->date->format('Y-m-d')); ?>" 
                                               required>
                                    </div>
                                </div>
                                    ...
                                    <select class="form-select border-1 rounded-2 py-2 px-3 select2-joborder" 
                                        ...
                                        <?php $__currentLoopData = $jobOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jobOrder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($jobOrder->id); ?>" 
                                                    data-department-id="<?php echo e($jobOrder->department_id); ?>"
                                                    data-project-id="<?php echo e($jobOrder->project_id); ?>"
                                                    <?php echo e($purchase->job_order_id == $jobOrder->id ? 'selected' : ''); ?>>
                                    ...
                                    <select class="form-select border-1 rounded-2 py-2 px-3 select2-department" 
                                        ...
                                        <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($department->id); ?>" 
                                                    <?php echo e($purchase->department_id == $department->id ? 'selected' : ''); ?>>
                                    ...
                                    <select class="form-select border-1 rounded-2 py-2 px-3 select2-project" 
                                        ...
                                        <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($project->id); ?>" 
                                                    <?php echo e($purchase->project_id == $project->id ? 'selected' : ''); ?>>
                        ...
                        <div class="mb-4">
                            ...
                            <div id="restockSection" class="<?php echo e($purchase->purchase_type != 'restock' ? 'd-none' : ''); ?>">
                            ...
                            <div id="newItemSection" class="<?php echo e($purchase->purchase_type != 'new_item' ? 'd-none' : ''); ?>">
                                <div class="row g-2 mb-3">
                                    <div class="col-md-8">
                                        ...
                                        <input type="text" 
                                               ...
                                               name="new_item_name" 
                                               id="newItemName"
                                               value="<?php echo e($purchase->new_item_name); ?>"
                                    ...
                                    <select class="form-select border-1 rounded-2 py-2 px-3" 
                                        ...
                                        <?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($unit->id); ?>" 
                                                    <?php echo e($purchase->unit_id == $unit->id ? 'selected' : ''); ?>>
                                ...
                                <div class="col-md-3 mb-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" 
                                               ...
                                               step="100" 
                                               min="0" 
                                               value="<?php echo e($purchase->unit_price); ?>" 
                                               required>
                                    </div>
                                </div>
                                    ...
                                    <select class="form-select border-1 rounded-2 py-2 px-3" 
                                        ...
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($category->id); ?>" 
                                                    <?php echo e($purchase->category_id == $category->id ? 'selected' : ''); ?>>
                                    ...
                                    <div class="mt-2">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="is_offline_order" 
                                                   ...
                                                   <?php echo e(!$purchase->is_offline_order ? 'checked' : ''); ?>>
                            ...
                            <div class="row g-2 mt-2" id="trackingSection">
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="<?php echo e($purchase->tracking_number); ?>"
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="text" 
                                           class="form-control border-1 rounded-2 py-2 px-3" 
                                           name="resi_number" 
                                           value="<?php echo e($purchase->resi_number); ?>"
                            ...
                            <div class="row g-2">
                                <div class="col-md-4 mb-2">
                                    <div class="border rounded-2 p-3 bg-light text-center">
                                        ...
                                        <input type="hidden" name="total_price" id="totalPrice" value="<?php echo e($purchase->total_price); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" 
                                               ...
                                               step="100" 
                                               min="0" 
                                               value="<?php echo e($purchase->freight); ?>" 
                                               placeholder="0">
                                    </div>
                                ...
                                <div class="col-md-4 mb-2">
                                    <div class="border rounded-2 p-3 bg-success bg-opacity-10 text-center">
                                        ...
                                        <input type="hidden" name="invoice_total" id="invoiceTotal" value="<?php echo e($purchase->invoice_total); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-2">
                                ...
                                <textarea class="form-control border-1 rounded-2 py-2 px-3" 
                                          name="note" 
                                          rows="3"
                                          placeholder="Optional notes or special instructions..."><?php echo e($purchase->note); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="alert alert-light border small mb-4 p-2 rounded-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <div class="small text-dark"><?php echo e($purchase->pic->name ?? auth()->user()->name); ?></div>
                                </div>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculateTotals() {
        ...
        if (totalPrice !== parseInt("<?php echo e($purchase->total_price); ?>")) {
            displayTotalPrice.classList.add('text-warning');
        } else {
            displayTotalPrice.classList.remove('text-warning');
        }
        
        if (invoiceTotal !== parseInt("<?php echo e($purchase->invoice_total); ?>")) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\27JAN\resources\views/Procurement/Project-Purchase/edit.blade.php ENDPATH**/ ?>