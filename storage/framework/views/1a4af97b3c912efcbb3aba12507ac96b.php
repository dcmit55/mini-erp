            ...
            <div class="card-body">
                ...
                <div class="d-flex flex-column flex-lg-row align-items-lg-center gap-3 mb-3">
                    ...
                    <div class="ms-lg-auto">
                        <div class="d-flex flex-wrap gap-2 align-items-center justify-content-lg-end">
                            <?php if(auth()->user()->isLogisticAdmin() || auth()->user()->isReadOnlyAdmin()): ?>
                                <a href="<?php echo e(route('inventory.create')); ?>" class="btn btn-primary btn-sm">
                ...
                <div class="mb-3">
                    <form id="filter-form" class="row g-1">
                        ...
                        <?php if(in_array(auth()->user()->role, ['super_admin', 'admin_logistic', 'admin_finance', 'admin_procurement', 'admin'])): ?>
                            <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            <select id="unitFilter" class="form-select form-select-sm select2">
                                ...
                                <?php $__currentLoopData = \App\Models\Logistic\Unit::orderBy('name')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <table class="table table-hover align-middle table-sm" id="datatable">
                        <thead class="table-light text-nowrap">
                            <tr>
                                ...
                                <th>Category</th>
                                <th>Quantity</th>
                                <?php if(in_array(auth()->user()->role, ['super_admin', 'admin_logistic', 'admin_finance', 'admin', 'admin_procurement'])): ?>
                                    <th>Unit Price</th>
                                <?php endif; ?>
                                <th>Supplier</th>
                                <th>Location</th>
                        ...
                        <form method="POST" action="<?php echo e(route('inventory.import')); ?>" enctype="multipart/form-data">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <a href="<?php echo e(route('inventory.template')); ?>" class="btn btn-outline-secondary btn-sm">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#export-btn').on('click', function() {
                ...
                const exportUrl = "<?php echo e(route('inventory.export')); ?>" +
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\27JAN\resources\views/logistic/inventory/index.blade.php ENDPATH**/ ?>