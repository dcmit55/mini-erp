...
<?php $__env->startSection('title', 'Project Purchase Orders'); ?>
    ...
    <div class="row justify-content-center">
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="<?php echo e(route('project-purchases.create')); ?>" 
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1">
                                    ...
                                    <h3 class="mb-0"><?php echo e($stats['approved'] ?? 0); ?></h3>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1">
                                    ...
                                    <h3 class="mb-0"><?php echo e($stats['rejected'] ?? 0); ?></h3>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1">
                                    ...
                                    <h3 class="mb-0"><?php echo e($stats['received'] ?? 0); ?></h3>
                                </div>
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body p-3">
                    <form method="GET" action="<?php echo e(route('project-purchases.index')); ?>">
                        <div class="row g-2">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-2">
                                <select name="project_type" class="form-select form-select-sm">
                                    ...
                                    <option value="client" <?php echo e(request('project_type') == 'client' ? 'selected' : ''); ?>>Client Project</option>
                                    <option value="internal" <?php echo e(request('project_type') == 'internal' ? 'selected' : ''); ?>>Internal Project</option>
                                </select>
                            </div>
                            <div class="col-md-2">
                        ...
                        <div class="row g-2 mt-2">
                            ...
                            <div class="col-md-2">
                                <select name="item_status" class="form-select form-select-sm">
                                    ...
                                    <option value="pending" <?php echo e(request('item_status') == 'pending' ? 'selected' : ''); ?>>Pending Receipt</option>
                                    <option value="received" <?php echo e(request('item_status') == 'received' ? 'selected' : ''); ?>>Received</option>
                                    <option value="not_received" <?php echo e(request('item_status') == 'not_received' ? 'selected' : ''); ?>>Not Received</option>
                                </select>
                            </div>
                            <div class="col-md-2">
                                <select name="order_type" class="form-select form-select-sm">
                                    <option value="">Order Type</option>
                                    <option value="online" <?php echo e(request('order_type') == 'online' ? 'selected' : ''); ?>>Online Order</option>
                                    <option value="offline" <?php echo e(request('order_type') == 'offline' ? 'selected' : ''); ?>>Offline Order</option>
                                </select>
                            </div>
                            <div class="col-md-3">
                                <?php if(request()->anyFilled(['search', 'status', 'department_id', 'project_type', 'date', 'purchase_type', 'item_status', 'order_type'])): ?>
                                <a href="<?php echo e(route('project-purchases.index')); ?>" class="btn btn-outline-secondary btn-sm w-100">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $purchases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="align-middle">
                                        <td class="ps-4 text-center">
                                            <span class="text-muted"><?php echo e($startingNumber + $index); ?></span>
                                        </td>
                                        <td>
                                            <div class="d-flex flex-column">
                                                <span class="fw-medium text-primary"><?php echo e($purchase->po_number); ?></span>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="text-muted"><?php echo e($purchase->date->format('d/m/Y')); ?></span>
                                        </td>
                                        <td>
                                            <div class="d-flex flex-column">
                                                <span class="fw-medium"><?php echo e($purchase->material_name); ?></span>
                                                <div class="d-flex align-items-center gap-2 mt-1">
                                                    <?php if($purchase->isNewItem()): ?>
                                                    <?php endif; ?>
                                                    <?php if($purchase->isClientProject()): ?>
                                                    <?php elseif($purchase->isInternalProject()): ?>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="text-muted"><?php echo e($purchase->department->name ?? 'N/A'); ?></span>
                                        </td>
                                        <td>
                                            <?php if($purchase->isClientProject()): ?>
                                                <div class="d-flex flex-column">
                                                    <span><?php echo e($purchase->project->name ?? 'N/A'); ?></span>
                                                    <?php if($purchase->jobOrder): ?>
                                                    <?php endif; ?>
                                                </div>
                                            <?php else: ?>
                                                <div class="d-flex flex-column">
                                                    <span><?php echo e($purchase->internalProject->project ?? 'N/A'); ?></span>
                                                    <?php if($purchase->internalProject): ?>
                                                    <?php endif; ?>
                                                </div>
                                            <?php endif; ?>
                                        </td>
                                        <td class="text-end">
                                            <span class="fw-medium"><?php echo e(number_format($purchase->quantity)); ?></span>
                                        </td>
                                        <td>
                                            <span class="text-muted"><?php echo e($purchase->unit->name ?? 'pcs'); ?></span>
                                        </td>
                                        <td class="text-end">
                                            <div class="d-flex flex-column align-items-end">
                                                <span class="fw-semibold">Rp <?php echo e(number_format($purchase->invoice_total, 0)); ?></span>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="badge <?php echo e($purchase->status_badge_class); ?> px-3 py-1 rounded-pill">
                                                <?php echo e($purchase->status_text); ?>

                                            </span>
                                            <?php if($purchase->isApproved() && $purchase->finance_approver): ?>
                                                <small class="d-block text-muted mt-1">
                                                    <i class="fas fa-user-check me-1"></i><?php echo e($purchase->finance_approver->username ?? 'Finance'); ?>

                                                </small>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <span class="badge <?php echo e($purchase->item_status_badge_class); ?> px-3 py-1 rounded-pill">
                                                <?php echo e($purchase->item_status_text); ?>

                                            </span>
                                            <?php if($purchase->isItemReceived() && $purchase->received_at): ?>
                                            <?php endif; ?>
                                        </td>
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center gap-1">
                                                ...
                                                <?php if($purchase->canDelete()): ?>
                                                <form action="<?php echo e(route('project-purchases.destroy', $purchase->id)); ?>" 
                                                      method="POST" class="d-inline" 
                                                      onsubmit="return confirm('Delete purchase order <?php echo e($purchase->po_number); ?>?')">
                                                    <?php echo csrf_field(); ?>
                                                ...
                                                <?php if($purchase->isPending() && auth()->user()->role == 'finance'): ?>
                                                <button type="button" 
                                                        class="btn btn-sm btn-outline-success border-0 px-2 action-btn"
                                                        data-bs-toggle="modal" 
                                                        data-bs-target="#approveModal<?php echo e($purchase->id); ?>"
                                                        title="Approve PO">
                                                ...
                                                <button type="button" 
                                                        class="btn btn-sm btn-outline-danger border-0 px-2 action-btn"
                                                        data-bs-toggle="modal" 
                                                        data-bs-target="#rejectModal<?php echo e($purchase->id); ?>"
                                                        title="Reject PO">
                                                ...
                                                <?php if($purchase->isApproved() && $purchase->isItemPending()): ?>
                                                <button type="button" 
                                                        class="btn btn-sm btn-outline-success border-0 px-2 action-btn"
                                                        data-bs-toggle="modal" 
                                                        data-bs-target="#receiveModal<?php echo e($purchase->id); ?>"
                                    ...
                                    <!-- Approve Modal -->
                                    <?php if($purchase->isPending() && auth()->user()->role == 'finance'): ?>
                                    <div class="modal fade" id="approveModal<?php echo e($purchase->id); ?>" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                <form action="<?php echo e(route('project-purchases.approve', $purchase->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <p class="fw-medium"><?php echo e($purchase->po_number); ?> - <?php echo e($purchase->material_name); ?></p>
                                                        
                                                        <?php if(!$purchase->is_offline_order): ?>
                                                        <div class="mb-2">
                                    ...
                                    <!-- Reject Modal -->
                                    <?php if($purchase->isPending() && auth()->user()->role == 'finance'): ?>
                                    <div class="modal fade" id="rejectModal<?php echo e($purchase->id); ?>" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                <form action="<?php echo e(route('project-purchases.reject', $purchase->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <div class="modal-header">
                                    ...
                                    <!-- Receive Modal -->
                                    <?php if($purchase->isApproved() && $purchase->isItemPending()): ?>
                                    <div class="modal fade" id="receiveModal<?php echo e($purchase->id); ?>" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                <form action="<?php echo e(route('project-purchases.mark-as-received', $purchase->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <p class="fw-medium"><?php echo e($purchase->po_number); ?></p>
                                                        <p class="mb-0"><?php echo e($purchase->material_name); ?></p>
                                                        <p class="small text-muted">Qty: <?php echo e(number_format($purchase->quantity)); ?> <?php echo e($purchase->unit->name ?? 'pcs'); ?></p>
                                                        
                                                        <?php if($purchase->tracking_number || $purchase->resi_number): ?>
                                                        <div class="alert alert-info p-2 mt-2">
                                                            <small>
                                                                <?php if($purchase->tracking_number): ?>
                                                                    <div><i class="fas fa-truck me-1"></i>Tracking: <?php echo e($purchase->tracking_number); ?></div>
                                                                <?php endif; ?>
                                                                <?php if($purchase->resi_number): ?>
                                                                    <div><i class="fas fa-barcode me-1"></i>Resi: <?php echo e($purchase->resi_number); ?></div>
                                                                <?php endif; ?>
                                                            </small>
                                                        </div>
                                                        <?php endif; ?>
                ...
                <div class="card-footer bg-white border-0 py-3 px-4">
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center">
                        <div class="text-muted small mb-2 mb-md-0">
                            Menampilkan <?php echo e($purchases->firstItem()); ?> - <?php echo e($purchases->lastItem()); ?> dari <?php echo e($purchases->total()); ?> data
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="join">
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e($purchases->previousPageUrl()); ?>" class="join-item btn">
                                        <i class="fas fa-chevron-left"></i>
                                    </a>
                                <?php endif; ?>
                                ...
                                <?php if($purchases->hasMorePages()): ?>
                                    <a href="<?php echo e($purchases->nextPageUrl()); ?>" class="join-item btn">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\27JAN\resources\views/Procurement/Project-Purchase/index.blade.php ENDPATH**/ ?>