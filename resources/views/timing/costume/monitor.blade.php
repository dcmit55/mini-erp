    ...
    <div class="container-fluid py-3">
        ...
        <div class="d-flex flex-column flex-lg-row align-items-lg-center gap-2 mb-3">
            <div class="d-flex align-items-center">
                ...
                <h2 class="mb-0" style="font-size:1.2rem;">👔 Costume Running Monitor</h2>
            </div>
        ...
        @else
            <div class="card shadow-sm border-0">
                <div class="card-body text-center py-5">
                    ...
                    <h5 class="text-muted mt-2">No Running Costume Sessions</h5>
                    <p class="text-muted small">Start a new timing session from Costume Timing</p>
                    <a href="{{ route('costume-timing.index') }}" class="btn btn-primary btn-sm mt-2">
