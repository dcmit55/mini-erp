                    ...
                    @php
                        ...
                        foreach ($allPermissions as $module => $permissions) {
                            if ($module === 'production') {
                                ...
                                if ($prodPerms->isNotEmpty()) {
                                    $splitPermissions['production'] = $prodPerms;
                                }
                                if ($timingPerms->isNotEmpty()) {
                                    $splitPermissions['timing'] = $timingPerms;
                                }
                            } else {
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        <div class="d-flex align-items-center gap-2">
                                            <i class="fas {{ $meta['icon'] }}"
                                                style="color:{{ $meta['color'] }};font-size:0.85rem;"></i>
                                        ...
                                        <label class="d-flex align-items-center gap-1 mb-0"
                                            style="cursor:pointer;font-size:0.72rem;color:#888;">
