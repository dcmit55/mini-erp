...
@section('content')
    <div class="container mt-4">
        <div class="card shadow rounded">
            <div class="card-body">
                <h2 class="mb-0 flex-shrink-0" style="font-size:1.3rem;">Goods Out - {{ $materialRequest->inventory->name ?? $materialRequest->stagingInventory->name ?? 'Material' }}
                </h2>
                <hr>
                @if (session('error'))
                    ...
                    <div class="row">
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="text" class="form-control"
                                value="{{ $materialRequest->remaining_qty }} {{ $mrUnit }}"
