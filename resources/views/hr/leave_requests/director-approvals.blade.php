...
@section('title', 'Director Leave Approvals')
    ...
    <div class="col-12">
        ...
        <div class="position-relative d-flex align-items-center mb-3" style="min-height:44px;">
            <div class="d-flex align-items-center gap-2 flex-shrink-0">
                <a href="{{ route('leave_requests.hr-approvals') }}" class="btn btn-outline-primary btn-sm rounded-2 px-3 position-relative">
                ...
                <a href="{{ route('leave_requests.director-approvals') }}" class="btn btn-primary btn-sm rounded-2 px-3 position-relative">
            ...
            <div class="position-absolute start-50 translate-middle-x text-center d-none d-md-block" style="pointer-events:none;">
                <h5 class="text-dark fw-semibold mb-0">Director Leave Approvals</h5>
            </div>
        ...
        <div class="card border-0 shadow-sm rounded-3 mb-3">
            <div class="card-body p-3">
                <form method="GET" action="{{ route('leave_requests.director-approvals') }}" class="row g-2">
                    ...
                    <div class="col-6 col-md-2 d-flex align-items-end">
                        <div class="d-flex gap-1">
                            ...
                            <a href="{{ route('leave_requests.director-approvals') }}" class="btn btn-outline-secondary btn-sm rounded-2 px-2">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="9" class="text-center py-5">
                                    ...
                                    <span class="text-muted small">No pending director approvals.</span>
                                </td>
                            </tr>
                            @else
                                ...
                                <td class="px-3 py-2 text-end">
                                    <div class="d-flex gap-1 justify-content-end">
                                        ...
                                        <form action="{{ route('leave_requests.updateApproval', $leave->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Approve?')">
                                            @csrf
                                            <input type="hidden" name="approval_2" value="approved">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="rejectForm" method="POST">
                @csrf
                <input type="hidden" name="approval_2" value="rejected">
