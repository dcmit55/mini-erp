...
<div class="container-fluid py-4">
    ...
    <div class="row align-items-center mb-4">
        <div class="col">
            <div class="d-flex align-items-center gap-3">
                <div class="icon-shape icon-lg bg-soft-warning rounded-3">
                    <i class="fas fa-clock text-warning fs-4"></i>
                </div>
                <div>
                    <h4 class="mb-1 fw-semibold">HR Attendance</h4>
                    <p class="text-muted mb-0">Pantau kehadiran harian, ringkasan bulanan, dan live monitor</p>
                </div>
            </div>
        </div>
        <div class="col-auto">
    ...
    <div class="mb-4">
        <div class="d-flex align-items-center gap-2 mb-3">
            <div class="line"></div>
            <h6 class="text-uppercase fw-semibold mb-0 tracking-wide">Attendance Tools</h6>
        </div>
        <div class="row g-3">

            <div class="col-lg-6">
                <a href="{{ route('attendance-logs.summary') }}" class="text-decoration-none">
                        ...
                        <div class="card-body p-3">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <p class="text-muted small mb-0">Ringkasan kehadiran bulanan — capacity, present, alpha, leave</p>
                                </div>
            ...
            <div class="col-lg-6">
                <a href="{{ route('attendance-logs.index') }}" class="text-decoration-none">
                    <div class="card border-0 shadow-xs hover-lift h-100 menu-card">
                        <div class="card-body p-3">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="mb-1 fw-semibold">Daily Attendance</h6>
                                    <p class="text-muted small mb-0">Log kehadiran harian per karyawan beserta detail jam kerja</p>
                                </div>
            ...
            <div class="col-lg-6">
                <a href="{{ route('session-shifts.live-monitor') }}" class="text-decoration-none">
                    <div class="card border-0 shadow-xs hover-lift h-100 menu-card">
                        <div class="card-body p-3">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="mb-1 fw-semibold">Live Attendance</h6>
                                    <p class="text-muted small mb-0">Monitor kehadiran secara real-time (live tap karyawan)</p>
                                </div>
