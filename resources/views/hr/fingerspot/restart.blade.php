...
@section('title', 'Restart Device - Fingerspot')
        ...
        <div class="col-12 col-xl-8">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div>
                    ...
                    <h5 class="text-dark mb-1 mt-2">Restart Device</h5>
                    <p class="text-muted small mb-0">Reboot the fingerprint device remotely</p>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm rounded-3 overflow-hidden">
                <div class="card-body p-3">
                    ...
                    <form action="{{ route('fingerspot.restart') }}" method="POST"
                          onsubmit="return confirm('Are you sure you want to restart the device? It will be temporarily offline.')">
                        @csrf
                        ...
                        <div class="d-flex gap-2 pt-3 border-top">
                            ...
                            <button type="submit" class="btn btn-secondary rounded-2 px-3 btn-sm">
                                <i class="fas fa-power-off me-1"></i> Restart Device
                            </button>
                        </div>
                    </form>
                </div>
