        ...
        <div class="card shadow rounded">
            <div class="card-body">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <h2 class="mb-0 flex-shrink-0" style="font-size:1.3rem;">Edit Supplier</h2>
                </div>
                <hr>
                ...
                <form method="POST" action="{{ route('suppliers.update', $supplier->id) }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="supplier_code" name="supplier_code"
                                    value="{{ old('supplier_code', str_replace('SUP', '', $supplier->supplier_code)) }}"
                                    placeholder="001">
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="tel" class="form-control" id="contact_person" name="contact_person"
                                ...
                                placeholder="e.g., +62812345678" maxlength="20">
                            ...
                            <select name="location_id" id="location_id" class="form-select select2">
                                ...
                                @foreach ($locations as $location)
                                    <option value="{{ $location->id }}"
                                        {{ old('location_id', $supplier->location_id) == $location->id ? 'selected' : '' }}>
                                        {{ $location->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="address" name="address" rows="3" placeholder="Enter complete address">{{ old('address', $supplier->address) }}</textarea>
                        @error('address')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                        ...
                        <div class="col-lg-4 mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" id="lead_time_days" name="lead_time_days"
                                    ...
                                    placeholder="For Example 8" required maxlength="10">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <select name="status" id="status" class="form-select" required>
                                ...
                                <option value="inactive"
                                    {{ old('status', $supplier->status) == 'inactive' ? 'selected' : '' }}>Inactive
                                </option>
                                <option value="blacklisted"
                                    {{ old('status', $supplier->status) == 'blacklisted' ? 'selected' : '' }}>Blacklisted
                                </option>
                            </select>
                            @error('status')
                                <small class="text-danger">{{ $message }}</small>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" id="remark" name="remark" rows="3"
                            placeholder="Additional notes or remarks (optional)">{{ old('remark', $supplier->remark) }}</textarea>
                        @error('remark')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('suppliers.index') }}" class="btn btn-secondary">Cancel
                        </a>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (form && submitBtn && spinner) {
                form.addEventListener('submit', function() {
                    ...
                    submitBtn.childNodes[submitBtn.childNodes.length - 1].textContent = ' Updating...';
                });
            }
        });
    </script>
