            ...
            <div class="card-body">
                ...
                <div class="d-flex flex-column flex-sm-row align-items-sm-center gap-2 mb-3">
                    <div class="d-flex align-items-center mb-2 mb-sm-0">
                        ...
                        <h2 class="mb-0 flex-shrink-0" style="font-size:1.3rem;">Lark SG-BT Item Tracking</h2>
                    </div>
                    <div class="ms-sm-auto d-flex flex-wrap gap-2">
                        <a href="{{ route('lark.staging.bt-sg-items') }}" class="btn btn-outline-primary btn-sm">
                            <i class="bi bi-arrow-left-right me-1"></i> BT-SG Items
                        </a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('lark.staging.sync-sg-bt-items') }}" method="POST" style="display:inline;">
                        @csrf
