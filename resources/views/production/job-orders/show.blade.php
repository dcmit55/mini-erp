    ...
    <div class="row">
        <div class="col-12">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="fw-medium">
                                        @if($jobOrder->start_date && $jobOrder->end_date)
                                            @php
                                                $days = \Carbon\Carbon::parse($jobOrder->start_date)
                                                    ->diffInDays(\Carbon\Carbon::parse($jobOrder->end_date));
                                            @endphp
                                            {{ $days }} days
                                        @else
                                            <span class="text-muted">-</span>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-muted small">{{ $jobOrder->created_at->diffForHumans() }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-muted small">{{ $jobOrder->updated_at->diffForHumans() }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                <!-- Delete Button -->
                <form action="{{ route('production.job-orders.destroy', $jobOrder->id) }}" 
                      method="POST" 
                      class="d-inline"
