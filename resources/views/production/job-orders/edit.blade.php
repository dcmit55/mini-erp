                                ...
                                <div class="row g-2">
                                    <div class="col-md-12 mb-2">
                                        ...
                                        <input type="text"
                                            ...
                                            id="name" name="name" value="{{ old('name', $jobOrder->name) }}"
                                    ...
                                    <div class="col-md-12 mb-2">
                                        ...
                                        <textarea class="form-control border-1 rounded-2 py-2 px-3 @error('description') is-invalid @enderror" id="description"
                                            name="description" rows="2" placeholder="Tambahkan deskripsi job order">{{ old('description', $jobOrder->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback small">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mb-2">
                                    ...
                                    <textarea class="form-control border-1 rounded-2 py-2 px-3 @error('notes') is-invalid @enderror" id="notes"
                                        name="notes" rows="2" placeholder="Tambahkan note">{{ old('notes', $jobOrder->notes) }}</textarea>
                                    @error('notes')
                                        <div class="invalid-feedback small">{{ $message }}</div>
                                    @enderror
                                </div>
