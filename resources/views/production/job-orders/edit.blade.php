    ...
    <div class="row justify-content-center">
        <div class="col-12 col-xl-8">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div>
                    <a href="{{ route('production.job-orders.index') }}" class="btn btn-outline-secondary btn-sm rounded-2 px-3">
                        <i class="fas fa-arrow-left me-1"></i>Back
                    </a>
                    <h5 class="text-dark mb-1 mt-2">Edit Form</h5>
                    <div class="d-flex align-items-center gap-2">
                        <span class="badge bg-light text-dark border rounded-2 px-2 py-1 small">
                            <i class="fas fa-hashtag me-1"></i>{{ $jobOrder->id }}
                        </span>
                        <p class="text-muted small mb-0">Update job order information</p>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-3">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-2">
                                <div class="col-md-12 mb-2">
                                    <label for="name" class="form-label small text-dark">Nama Job Order <span class="text-danger">*</span></label>
                                    <input type="text" 
                                ...
                                <div class="col-md-6 mb-2">
                                    <label for="project_id" class="form-label small text-dark">Project <span class="text-danger">*</span></label>
                                    <select class="form-select border-1 rounded-2 py-2 px-3 @error('project_id') is-invalid @enderror" 
                                            id="project_id" 
                                            name="project_id"
                                            required>
                                ...
                                <div class="col-md-6 mb-2">
                                    <label for="department_id" class="form-label small text-dark">Department <span class="text-danger">*</span></label>
                                    <select class="form-select border-1 rounded-2 py-2 px-3 @error('department_id') is-invalid @enderror" 
                                            id="department_id" 
                                            name="department_id" 
                                            required>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-2">
                            ...
                            <textarea class="form-control border-1 rounded-2 py-2 px-3 @error('notes') is-invalid @enderror" 
                                    id="notes" 
                                    name="notes" 
                                    rows="2"
