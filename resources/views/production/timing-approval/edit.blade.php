        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                ...
                <small class="text-muted">ID #{{ $timing->id }} &mdash; Status:
                    <span
                        class="badge {{ $timing->isPending() ? 'bg-warning text-dark' : ($timing->isApproved() ? 'bg-success' : 'bg-danger') }}">
        ...
        <div class="row g-4">
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('timing-approval.update', $timing->id) }}" method="POST" id="editForm">
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="form-control @error('tanggal') is-invalid @enderror"
                                        name="tanggal" value="{{ old('tanggal', $timing->tanggal?->format('Y-m-d')) }}"
                                        required>
                                    @error('tanggal')
                                ...
                                <div class="col-md-8">
                                    <label class="form-label fw-medium">Employee(s) <span
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select select2 @error('project_id') is-invalid @enderror"
                                        ...
                                        @foreach ($projects as $p)
                                            <option value="{{ $p->id }}"
                                                {{ old('project_id', $timing->project_id) == $p->id ? 'selected' : '' }}>
                                                {{ $p->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row g-3 mb-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" min="0" max="480"
                                                ...
                                                value="{{ $existingBreak }}" placeholder="0">
                                            <span class="input-group-text">min</span>
                                        </div>
                                        @if ($timing->total_paused_minutes > 0 && $timing->break_deducted_minutes == 0)
                                            <small class="text-info">
                                                <i class="bi bi-info-circle me-1"></i>Pre-filled dari pause app
                                                ({{ $timing->total_paused_minutes }} min)
                                            </small>
                                        @else
                                            <small class="text-muted">Dikurangi dari durasi total</small>
                                        @endif
                                        @error('break_deducted_minutes')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                {{-- Duration Preview --}}
                                <div class="rounded-2 px-3 py-2 mb-3"
                                ...
                                <div class="row g-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text"
                                            class="form-control @error('measurement_type') is-invalid @enderror"
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control @error('remarks') is-invalid @enderror" name="remarks" rows="2"
            ...
            <div class="col-lg-4">
                    ...
                    <div class="card border-0 shadow-sm mb-3">
                        ...
                        <div class="card-body p-3" style="font-size:.82rem;">
                            ...
                            @if ($timing->rejection_reason)
                                <div class="mt-2 p-2 rounded bg-danger bg-opacity-10 text-danger"
                ...
                <div class="card border-0 shadow-sm" style="border-left:3px solid #f59e0b !important;">
                    <div class="card-body p-3">
                        <p class="mb-1 fw-semibold text-warning" style="font-size:.82rem;"><i
                                class="bi bi-cup-hot me-1"></i>Break Deduction</p>
    ...
    <script>
        $(function() {
            ...
            function updateDuration() {
                ...
                $('#duration-breakdown').text(b > 0 ? '(' + Math.floor(raw / 60) + 'h ' + Math.round(raw % 60) +
                    'm gross − ' + b + 'm break)' : '');
            }
