                            ...
                            @if (in_array(auth()->user()->role, [
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle {{ isDropdownActive($procurementPrefixes) ? 'active' : '' }}"
                                        href="#" id="procurementDropdown" role="button" data-bs-toggle="dropdown"
                                        aria-expanded="false">
                                        <i></i>Procurement
                                    </a>
                                ...
                                @if (in_array(auth()->user()->role, [
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="timingDropdown">
                                            ...
                                            <!-- Overtime Requests -->
                                            <li>
                                                <a class="dropdown-item {{ request()->routeIs('overtime-requests.hr-approvals') ? 'active' : '' }}"
                                                    href="{{ route('overtime-requests.hr-approvals') }}">
                                                    <i class="fas fa-user-check me-2"></i>HR Overtime Approvals
                                                </a>
                                            </li>
                                            <!-- Director Overtime Approvals -->
                                            <li>
                                                <a class="dropdown-item {{ request()->routeIs('overtime-requests.director-approvals') ? 'active' : '' }}"
                                                    href="{{ route('overtime-requests.director-approvals') }}">
                                                    <i class="fas fa-user-tie me-2"></i>Director Overtime Approvals
                                                </a>
                                            </li>
                                            <!-- OT vs Attendance -->
                                            <li>
                                                <a class="dropdown-item {{ request()->routeIs('overtime-requests.attendance-comparison') ? 'active' : '' }}"
                                                    href="{{ route('overtime-requests.attendance-comparison') }}">
                                                    <i class="fas fa-chart-bar me-2"></i>OT vs Attendance
                                                </a>
                                            </li>
                                            <!-- Overtime Pay -->
                                            <li>
...
<<<<<<< HEAD
                                ...
                                @auth
                                    @if (in_array(auth()->user()->role, ['super_admin', 'admin_hr', 'admin']))
                                        <li class="nav-item dropdown">
                                            <a class="nav-link dropdown-toggle {{ request()->is('employees*') || request()->routeIs('leave_requests.index') || request()->is('attendance*') || request()->routeIs('employee-work-policies.*') || request()->routeIs('timings.*') || request()->routeIs('attendance-logs.*') ? 'active' : '' }}"
                                                href="#" id="hrDropdown" role="button" data-bs-toggle="dropdown"
                                                aria-expanded="false">
                                                <i></i>HR
                                            </a>
